...
<!-- Modal -->
<div class="modal fade" id="modalAgregarUsuario" tabindex="-1" role="dialog" aria-labelledby="modalAgregarUsuario"
    aria-hidden="true">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="text" id="nuevoUsuario" name="nuevoUsuario"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="password" name="nuevoPassword2"
                                        placeholder="Ingrese Contraseña Nuevamente" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="password" name="editarPassword"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="password" name="editarPassword2"
